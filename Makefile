#############################################################################
# Makefile for building: QtMeteo
# Generated by qmake (2.01a) (Qt 4.8.1) on: Tue Nov 19 16:37:52 2013
# Project:  QtMeteo.pro
# Template: app
# Command: /opt/QtSDK/Desktop/Qt/4.8.1/gcc/bin/qmake -spec /opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/linux-g++ -o Makefile QtMeteo.pro
#############################################################################
...
Makefile: QtMeteo.pro  /opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/linux-g++/qmake.conf /opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/unix.conf \
		/opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/linux.conf \
		/opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/gcc-base.conf \
		/opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/gcc-base-unix.conf \
		/opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/linux-g++ -o Makefile QtMeteo.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/QtMeteo1.0.0 || $(MKDIR) .tmp/QtMeteo1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/QtMeteo1.0.0/ && $(COPY_FILE) --parents dialog.h xml.h meteo.h condition.h fonction.h .tmp/QtMeteo1.0.0/ && $(COPY_FILE) --parents main.cpp dialog.cpp xml.cpp meteo.cpp .tmp/QtMeteo1.0.0/ && $(COPY_FILE) --parents dialog.ui .tmp/QtMeteo1.0.0/ && (cd `dirname .tmp/QtMeteo1.0.0` && $(TAR) QtMeteo1.0.0.tar QtMeteo1.0.0 && $(COMPRESS) QtMeteo1.0.0.tar) && $(MOVE) `dirname .tmp/QtMeteo1.0.0`/QtMeteo1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/QtMeteo1.0.0
...
moc_dialog.cpp: meteo.h \
		condition.h \
		xml.h \
		dialog.h
	/opt/QtSDK/Desktop/Qt/4.8.1/gcc/bin/moc $(DEFINES) $(INCPATH) dialog.h -o moc_dialog.cpp
...
ui_dialog.h: dialog.ui
	/opt/QtSDK/Desktop/Qt/4.8.1/gcc/bin/uic dialog.ui -o ui_dialog.h
...
meteo.o: meteo.cpp meteo.h \
		condition.h \
		xml.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o meteo.o meteo.cpp
